...
for i in range(len(find_in_keybinds)):
    with in_place.InPlace("/home/sidney/dotfiles/.config/hypr/conf/keybindings/default.conf") as file:
        for line in file:
...
for i in range(len(find_in_monitors)):
    with in_place.InPlace('/home/sidney/dotfiles/.config/hypr/conf/monitors/default.conf') as file:
        for line in file:
...
for i in range(len(find_in_autostart)):
    with in_place.InPlace('/home/sidney/dotfiles/.config/hypr/conf/autostart.conf') as file:
        for line in file:
...
for i in range(len(find_in_system_monitor)):
    with in_place.InPlace('/home/sidney/dotfiles/.config/ml4w/settings/system-monitor.sh') as file:
        for line in file:
...
for i in range(len(find_in_config)):
    with in_place.InPlace('/home/sidney/dotfiles/.config/waybar/themes/ml4w/config') as file:
        for line in file:
...
for i in range(len(find_in_style)):
    with in_place.InPlace('/home/sidney/dotfiles/.config/waybar/themes/ml4w/style.css') as file:
        for line in file:
...
for i in range(len(find_in_module)):
    with in_place.InPlace('/home/sidney/dotfiles/.config/waybar/modules.json') as file:
        for line in file:
